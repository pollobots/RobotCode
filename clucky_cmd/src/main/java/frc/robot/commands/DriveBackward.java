...
/**
 * Drives robot backward for given period of time.
 */
public class DriveBackward extends WaitCommand {
  ...
  /**
   * Creates a new DriveBackward command.
   *
   * @param driveTrain The drivetrain subsystem used by this command
   */
  public DriveBackward(double seconds, DriveSubsystem driveTrain) {
    // WRITE CODE BETWEEN THESE LINES -------------------------------------------------------- //
  ...
  public void initialize() {
    // WRITE CODE BETWEEN THESE LINES -------------------------------------------------------- //
    // TODO: set driveTrain to drive straight backward
    m_driveTrain.tankDrive(DriveConstants.kDriveBackSpeed, DriveConstants.kDriveBackSpeed);
    // ^^-----------------------------------------------------------------------------------^^ //
    super.initialize();
  }
